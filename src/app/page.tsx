          ...
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4 mt-8">
              <div>
                <Link
                  href="/login"
                  className="px-8 py-3.5 rounded-xl font-mono font-bold text-white bg-[#2563EB] hover:bg-blue-700 shadow-md transition-all flex items-center gap-2 text-xs uppercase tracking-wider hover:shadow-lg"
                >
                  Start Learning Free
              ...
              <div>
                <Link
                  href="/subjects"
                  className="px-8 py-3.5 rounded-xl font-mono font-bold text-[#1E293B] bg-white/90 hover:bg-white border border-[#E2E8F0] shadow-sm transition-all flex items-center gap-2 text-xs uppercase tracking-wider hover:border-[#CBD5E1]"
                >
                  Explore 19 Subjects
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={path.title}
                className="bg-[#F8FAFC] rounded-3xl border border-[#E2E8F0] p-6 hover:shadow-md hover:-translate-y-1 transition-all flex flex-col justify-between"
              >
                <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {displayedSubjects.map((subject) => (
              <div
                key={subject.id}
                className="group bg-white rounded-3xl border border-[#E2E8F0] overflow-hidden hover:border-[#2563EB] hover:shadow-md hover:-translate-y-1 transition-all flex flex-col justify-between"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {TOOLS.map((tool) => (
              <div
                key={tool.name}
                className="bg-[#F8FAFC] rounded-3xl border border-[#E2E8F0] p-6 hover:border-[#2563EB] hover:shadow-md hover:-translate-y-1 transition-all flex flex-col justify-between"
              >
                <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {INDUSTRIES.map((industry) => (
              <div
                key={industry.name}
                className="bg-white rounded-3xl border border-[#E2E8F0] p-6 hover:border-[#2563EB] hover:shadow-md hover:-translate-y-1 transition-all text-center flex flex-col justify-between"
              >
                <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {PILLARS.map((pillar) => (
              <div
                key={pillar.title}
                className="bg-[#F8FAFC] rounded-3xl border border-[#E2E8F0] p-6 shadow-xs flex flex-col justify-between hover:shadow-md hover:-translate-y-1 transition-all"
              >
                <div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div>
            ...
            <div className="mt-8">
              <Link
                href="/login"
                className="px-10 py-4 rounded-xl font-mono font-bold text-white bg-[#2563EB] hover:bg-blue-700 shadow-lg transition-all inline-flex items-center gap-2 text-xs uppercase tracking-wider hover:shadow-2xl hover:scale-105"
              >
                Start Learning Free
                <ArrowRight className="h-4 w-4" />
              </Link>
