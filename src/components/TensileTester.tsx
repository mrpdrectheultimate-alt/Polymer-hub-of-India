      ...
      <div className="space-y-4">
        ...
        <div className="border-4 border-slate-900 rounded-xl bg-slate-50 dark:border-slate-800 dark:bg-slate-900 p-4 flex gap-4 items-center justify-between">
          <div className="text-center space-y-1">
            ...
            <div className="w-14 h-24 bg-slate-200 dark:bg-slate-800 border-2 border-slate-400 rounded relative flex flex-col items-center justify-between py-2 overflow-hidden mx-auto">
              {/* Upper grip */}
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2 bg-slate-50 dark:bg-slate-900 p-3 rounded-lg border border-slate-200 dark:border-slate-800">
              <div>
                ...
                <strong className="text-xs text-slate-800 dark:text-slate-100">{results.modulus} GPa</strong>
              </div>
              <div>
                <span className="block text-[8px] font-mono text-slate-400 uppercase">Yield Strength (0.2%)</span>
                <strong className="text-xs text-slate-800 dark:text-slate-100">{results.yieldStrength} MPa</strong>
              </div>
              <div>
                <span className="block text-[8px] font-mono text-slate-400 uppercase">Ultimate Strength (UTS)</span>
                <strong className="text-xs text-slate-800 dark:text-slate-100">{results.ultimateStrength} MPa</strong>
              </div>
              <div>
                <span className="block text-[8px] font-mono text-slate-400 uppercase">Elongation at Break</span>
                <strong className="text-xs text-slate-800 dark:text-slate-100">{results.elongation}%</strong>
              </div>
            </div>
          </div>
        ) : (
