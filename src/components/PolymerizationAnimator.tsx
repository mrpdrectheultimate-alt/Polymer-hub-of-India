        ...
        <div className="flex gap-3">
          <button 
            ...
            className={`flex-1 py-2 border-2 border-slate-900 rounded-xl font-mono text-xs uppercase font-black transition-all ${
              mode === 'addition' ? 'bg-slate-900 text-white' : 'bg-slate-50 text-slate-800 hover:bg-slate-100'
            }`}
          ...
          <button 
            disabled={isRunning}
            className={`flex-1 py-2 border-2 border-slate-900 rounded-xl font-mono text-xs uppercase font-black transition-all ${
              mode === 'condensation' ? 'bg-slate-900 text-white' : 'bg-slate-50 text-slate-800 hover:bg-slate-100'
            }`}
        ...
        {chainLength > 0 ? (
          <div className="p-3 bg-green-50 border border-green-200 rounded-lg flex items-start gap-2.5">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[10px] text-green-700/85 leading-normal">
                {mode === 'addition' 
